...
THEME_NAME = "blossom_2025_10_30 4th"

THEME_BASE_DIR = "/Users/taro/sc/blossomhcompany/"
...
def create_redirect(client: BlossomClient, page_info, handle=""):
    client.create_url_redirect(
        f"/pages/{page_info['handle']}", f"/blogs/lookbook/{handle}"
    )


def process_page(client: BlossomClient, page_info):
