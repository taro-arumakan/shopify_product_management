...
def run(brand, report_year, report_month):
    ...
    output_path = f"/tmp/monthly_sales_by_product_graph_{datetime.date(report_year, report_month, 1):%Y%m}_{client.VENDOR}.png"
    client.generate_monthly_sales_by_product_graph(
