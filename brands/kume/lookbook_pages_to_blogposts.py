...
THEME_NAME = "2025 FALL prod"

THEME_BASE_DIR = "/Users/taro/sc/kume/"
...
def create_redirect(client: KumeClient, page_info, handle=""):
    client.create_url_redirect(
        f"/pages/{page_info['handle']}", f"/blogs/lookbook/{handle}"
    )


def process_page(client: KumeClient, page_info):
