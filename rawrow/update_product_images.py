...
def main():
    ...
    vendor = 'rawrow'
    product_info_list = product_info_list_from_sheet(client, client.sheet_id, '20250211_v3')
    ress = []
    for product_info in product_info_list:
        if product_info['title'] == 'R TRUNK LITE ep.3 37L / 20"':
            ress.append(client.process_product_images(product_info, '/Users/taro/Downloads/rawrow20250428/', 'upload_20250428_'))
    pprint.pprint(ress)
