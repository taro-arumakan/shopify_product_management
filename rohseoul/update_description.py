...
def main():
    ...
    product_info_list = product_info_lists_from_sheet(client, client.sheet_id, '25SS 2차오픈(4월)(Summer 25)', '25ss-2nd')

    for product_info in product_info_list:
        if product_info['title'] in ['Pulpy crossbody bag Nylon', 'Pulpy crossbody bag Wrinkled']:
            description_html = get_description_html(client, product_info['description'],
