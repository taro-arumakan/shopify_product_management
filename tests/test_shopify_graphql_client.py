...
class TestShopifyFunctions(unittest.TestCase):
    ...
    def test_update_product_description(self, mock_run_query):
        ...
        self.assertEqual(
            result["productUpdate"]["product"]["descriptionHtml"],
            "<p>New Description</p>",
        )
    ...
    def test_sanitize_image_name(self):
        ...
        result = sgc.sanitize_image_name(
            "Dummy Product [Special Edition]_product_details_01.png"
        )
        self.assertEqual(
            result, "Dummy_Product_Special_Edition__product_details_01.png"
        )
    ...
    def test_image_htmlfragment_in_description(self):
        ...
        sgc = ShopifyGraphqlClient("dummy_shop_name", "dummy_access_token")
        result = sgc.image_htmlfragment_in_description(
            "example_image.png", 2, "https://cdn.shopify.com/s/files/1/0745/9435/3408"
        )
        self.assertIn('<p class="reveal_tran_lr">', result)
        self.assertIn(
            '<img src="https://cdn.shopify.com/s/files/1/0745/9435/3408/files/example_image.png"',
            result,
        )
    ...
    def test_assign_images_to_product(self, mock_medias_by_product_id, mock_run_query):
        ...
        mock_medias_by_product_id.return_value = [
            {
                ...
                "image": {
                    "url": "https://cdn.shopify.com/s/files/1/0885/9435/0363/files/upload_20250218_KM-25SS-JP01-IV-S_00_2__44.jpg?v=1739867188"
                },
            ...
            },
            {
                ...
                "image": {
                    "url": "https://cdn.shopify.com/s/files/1/0885/9435/0363/files/upload_20250218_KM-25SS-JP01-IV-S_03_20240508_KUME25SS250940.jpg?v=1740622121"
                },
                "mediaContentType": "IMAGE",
                "mediaErrors": [],
                "mediaWarnings": [],
        ...
        alts = ["image1"]
        result = client.assign_images_to_product(
            resource_urls, alts, "gid://shopify/Product/12345"
        )
    ...
    def test_update_product_description_metafield(self, mock_run_query):
        ...
        client = ShopifyGraphqlClient(shop_name="dummy", access_token="dummy")
        result = client.update_product_description_metafield(
            "12345", {"rich_text": "Updated"}
        )
