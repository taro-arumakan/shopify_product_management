...
from helpers.snippets.inventory_set_quantity import (
    column_map,
    sku_quantity_map_from_sheet,
)
...
class TestInventorySetQuantity(unittest.TestCase):
    ...
    @patch("helpers.snippets.inventory_set_quantity.utils.client")
    def test_sku_quantity_map_from_sheet(self, mock_client_factory):
        ...
        mock_client.worksheet_rows.return_value = [[], [], [], row3, row4]
